                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-footer-widget marbtm50">
                            ...
                            <div class="our-company-info">
                                <div class="text-box">
                                    <p>Our vision is by 2035, Lagos is listed as one of the top cleanest cities in
                                        africa
                                        and the world at large. We need you to make this happen!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                <p>
                                                    <a href="mailto:hello@snapam.ng">hello@snapam.ng</a>
                                                </p>
                                            </div>
                                        </div>
                                    </li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="bottom-inner">
                    <div class="copyright">
                        <p>Copyright &copy; 2024 <a href="#">Snapam.ng</a> All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
